...
const product: [string, string | number] = [
...
const afterDiscount: number = totalPrice * discount;
const remainingStock: number = stock - quantity;

console.log("=================Sales Receipt=====================");
console.log("Is the customer a premium member :" + member);
console.log("keyboard brand :" + product);
console.log("keyboard price :" + price);
console.log("total price :" + totalPrice);
console.log("After discount A Premium Member :" + afterDiscount);
console.log("remaining stock keyboard :" + remainingStock);
console.log("==================================================");
